...
const Underground = () => (
  <div className="underground">
    ...
    <h2>Mer om webbtillgänglighet</h2>
      <ul>
        <li><a href="http://www.webbriktlinjer.se/">Webbriktlinjer.se</a></li>
        <li><a href="http://webaim.org/">WebAIM</a></li>
        <li><a href="http://a11yproject.com/">The Accessibility Project</a></li>
      </ul>
      <p>Vår meetup-grupp <a href="http://www.meetup.com/t12t-Stockholm/">t12t Stockholm finns på meetup.com.</a></p>
    </aside>
  </div>
)
  ...
  <div>
    <Helmet
      ...
      meta={[
        ...
        { name: 'msapplication-config', content: __PATH_PREFIX__+ '/favicons/browserconfig.xml' },
      ]}>
      <link rel="stylesheet" href="//fonts.googleapis.com/css?family=Patua+One:300,400,700" />
      ...
      <link rel="mask-icon" href={__PATH_PREFIX__ + '/favicons/safari-pinned-tab.svg'} color="#f95e00" />
