  ...
  <Layout>
    <div>
      ...
      <p>
        ...
        and Europe since these are the physical locations where this particular
        newsletter will be crafted. But the scope will be broad and cute animals
        will be featured.
      </p>
      <p>
        If everything goes according to the plan the newsletter will be sent out
        once every month but with no fixed schedule.
      </p>
      <Mailchimpform />
      <p>
        <em>
